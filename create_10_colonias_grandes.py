#!/usr/bin/env python3
"""
Crear 10 colonias grandes e importantes (total: 75 páginas).
...
# 10 colonias grandes e importantes
nuevas_colonias = [
    {'slug': 'adolfo-ruiz-cortines', 'name': 'Adolfo Ruiz Cortines', 'premium': False},
    {'slug': 'aurora', 'name': 'Aurora', 'premium': False},
    {'slug': 'buenos-aires', 'name': 'Buenos Aires', 'premium': False},
    {'slug': 'colinas-del-humaya', 'name': 'Colinas del Humaya', 'premium': False},
    {'slug': 'centro-sinaloa', 'name': 'Centro Sinaloa', 'premium': False},
    {'slug': 'diez-de-abril', 'name': '10 de Abril', 'premium': False},
    {'slug': 'infonavit-canadas', 'name': 'Infonavit Cañadas', 'premium': False},
    {'slug': 'felipe-angeles', 'name': 'Felipe Ángeles', 'premium': False},
    {'slug': 'jorge-almada', 'name': 'Jorge Almada', 'premium': False},
    {'slug': 'jesus-garcia', 'name': 'Jesús García', 'premium': False}
]

base_dir = Path('servicios/plomero-colonias-culiacan')

print(f"🏘️  CREANDO 10 COLONIAS GRANDES E IMPORTANTES (TOTAL: 75)\n")
print(f"{'='*70}")
...
print(f"\n{'='*70}")
print(f"📊 RESUMEN:")
print(f"  ✅ 10 colonias grandes creadas")
print(f"  📁 Total de colonias: 75")
