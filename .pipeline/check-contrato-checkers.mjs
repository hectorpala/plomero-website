...
const HEAVY = new Set(["check-produccion.mjs", "check-perf.mjs", "check-tracking.mjs", "check-tracking-deadline.py", "check-e2e.mjs", "check-visual.mjs"]); // tocan red: omitir en pre-push
const esUtilidad = (f) => {
