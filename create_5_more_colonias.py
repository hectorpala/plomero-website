#!/usr/bin/env python3
"""
Crear 5 colonias adicionales para llegar a 50 páginas totales.
...
# 5 nuevas colonias seleccionadas (popularidad e importancia)
nuevas_colonias = [
    {'slug': 'adolfo-lopez-mateos', 'name': 'Adolfo López Mateos', 'premium': False},
    {'slug': 'aeropuerto', 'name': 'Aeropuerto', 'premium': False},
    {'slug': 'diez-de-mayo', 'name': '10 de Mayo', 'premium': False},
    {'slug': 'emiliano-zapata', 'name': 'Emiliano Zapata', 'premium': False},
    {'slug': 'francisco-i-madero', 'name': 'Francisco I. Madero', 'premium': False}
]

base_dir = Path('servicios/plomero-colonias-culiacan')

print(f"🏘️  CREANDO 5 NUEVAS COLONIAS (TOTAL: 50)\n")
print(f"{'='*70}")
...
for colonia in nuevas_colonias:
    ...
    # 5. Mapa - usar mapa genérico de Culiacán
...
print(f"\n{'='*70}")
print(f"📊 RESUMEN:")
print(f"  ✅ 5 nuevas colonias creadas")
print(f"  📁 Total de colonias: 50")
print(f"  🗺️  Mapa: Culiacán genérico (sin logo gigante)")
